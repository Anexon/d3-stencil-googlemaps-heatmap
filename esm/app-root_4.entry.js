import { r as registerInstance, h, g as getElement, c as getContext } from './index-96f926c6.js';
import { A as ActiveRouter } from './active-router-b95e9f93.js';
...
const appRootCss = "header{background:#5851ff;color:white;height:56px;display:-ms-flexbox;display:flex;-ms-flex-align:center;align-items:center;-webkit-box-shadow:0 2px 5px 0 rgba(0, 0, 0, 0.26);box-shadow:0 2px 5px 0 rgba(0, 0, 0, 0.26)}h1{font-size:1.4rem;font-weight:500;color:#fff;padding:0 12px}";
...
const AppRoot = class {
    ...
    render() {
        return (h("div", null, h("header", null, h("h1", null, "GoogleMaps + Canvas - Heatmap"), h("span", null, "(Multiple Radius)")), h("main", null, h("stencil-router", null, h("stencil-route-switch", { scrollTopOffset: 0 }, h("stencil-route", { url: '/', component: 'app-home', exact: true }))))));
    }
};
...
export { AppRoot as app_root, Route as stencil_route, RouteSwitch as stencil_route_switch, Router as stencil_router };
