...
const AppRoot = class {
    ...
    render() {
        return (index.h("div", null, index.h("header", null, index.h("h1", null, "GoogleMaps + Canvas - Heatmap"), index.h("span", null, "(Multiple Radius)")), index.h("main", null, index.h("stencil-router", null, index.h("stencil-route-switch", { scrollTopOffset: 0 }, index.h("stencil-route", { url: '/', component: 'app-home', exact: true }))))));
    }
};
